...
<body>
    ...
    <div class="viewport" id="vp">
        <div class="world" id="world">
            ...
            {{-- ══ 地形 SVG ══ --}}
            <svg class="terrain-svg" viewBox="0 0 1800 1200" width="1800" height="1200"
                ...
                <path d="M133 202 Q216 110 300 110 Q383 110 467 202" stroke="#D2BD85" stroke-width="7" fill="none"
                    opacity="0.45" />
                <!-- 小廣場 中 -->
                ...
                <g stroke="#A07840" stroke-width="3" opacity="0.55">
                    ...
                    <line x1="50" y1="202" x2="50" y2="212" />
                    <line x1="100" y1="202" x2="100" y2="212" />
                    <line x1="150" y1="202" x2="150" y2="212" />
                    <line x1="200" y1="202" x2="200" y2="212" />
                    <line x1="250" y1="202" x2="250" y2="212" />
                    <line x1="300" y1="202" x2="300" y2="212" />
                    <line x1="350" y1="202" x2="350" y2="212" />
                    <line x1="400" y1="202" x2="400" y2="212" />
                    <line x1="450" y1="202" x2="450" y2="212" />
                    <line x1="500" y1="202" x2="500" y2="212" />
                ...
                <!-- 樹木群 -->
                <g transform="translate(97,41) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="13" ry="11" fill="#4A8038" />
                    <ellipse cx="14" cy="27" rx="15" ry="10" fill="#5A9048" />
                    <ellipse cx="14" cy="31" rx="12" ry="8" fill="#68A056" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(163,32) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="12" ry="10" fill="#4A8038" />
                    <ellipse cx="14" cy="27" rx="14" ry="9" fill="#5A9048" />
                    <ellipse cx="14" cy="31" rx="11" ry="7" fill="#68A056" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(97,111) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="13" ry="11" fill="#508840" />
                    <ellipse cx="14" cy="27" rx="15" ry="10" fill="#609858" />
                    <ellipse cx="14" cy="31" rx="12" ry="8" fill="#6EA864" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(463,41) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="12" ry="10" fill="#4A8038" />
                    <ellipse cx="14" cy="27" rx="14" ry="9" fill="#5A9048" />
                    <ellipse cx="14" cy="31" rx="11" ry="7" fill="#68A056" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(513,85) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="13" ry="11" fill="#508840" />
                    <ellipse cx="14" cy="27" rx="15" ry="10" fill="#609850" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(30,611) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="13" ry="11" fill="#4A8038" />
                    <ellipse cx="14" cy="27" rx="15" ry="10" fill="#5A9048" />
                    <ellipse cx="14" cy="31" rx="12" ry="8" fill="#68A056" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(97,670) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="12" ry="10" fill="#508840" />
                    <ellipse cx="14" cy="27" rx="14" ry="9" fill="#609850" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(30,743) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="11" ry="9" fill="#4A8038" />
                    <ellipse cx="14" cy="27" rx="13" ry="8" fill="#5A9048" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(163,582) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="13" ry="11" fill="#508840" />
                    <ellipse cx="14" cy="27" rx="15" ry="10" fill="#609850" />
                    <ellipse cx="14" cy="31" rx="12" ry="8" fill="#6EA860" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(1330,41) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="13" ry="11" fill="#4A8038" />
                    <ellipse cx="14" cy="27" rx="15" ry="10" fill="#5A9048" />
                    <ellipse cx="14" cy="31" rx="12" ry="8" fill="#68A056" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(1363,99) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="12" ry="10" fill="#508840" />
                    <ellipse cx="14" cy="27" rx="14" ry="9" fill="#609850" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(1330,290) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="13" ry="11" fill="#4A8038" />
                    <ellipse cx="14" cy="27" rx="15" ry="10" fill="#5A9048" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(1347,392) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="11" ry="9" fill="#508840" />
                    <ellipse cx="14" cy="27" rx="13" ry="8" fill="#609850" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(1547,904) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="13" ry="11" fill="#4A8038" />
                    <ellipse cx="14" cy="27" rx="15" ry="10" fill="#5A9048" />
                    <ellipse cx="14" cy="31" rx="12" ry="8" fill="#68A056" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(1630,948) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="12" ry="10" fill="#508840" />
                    <ellipse cx="14" cy="27" rx="14" ry="9" fill="#609850" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(1697,904) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="13" ry="11" fill="#4A8038" />
                    <ellipse cx="14" cy="27" rx="15" ry="10" fill="#5A9048" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(263,348) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="12" ry="10" fill="#508840" />
                    <ellipse cx="14" cy="27" rx="14" ry="9" fill="#609850" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(363,582) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="11" ry="9" fill="#4A8038" />
                    <ellipse cx="14" cy="27" rx="13" ry="8" fill="#5A9048" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(897,611) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="12" ry="10" fill="#508840" />
                    <ellipse cx="14" cy="27" rx="14" ry="9" fill="#609850" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(997,670) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="11" ry="9" fill="#4A8038" />
                    <ellipse cx="14" cy="27" rx="13" ry="8" fill="#5A9048" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(330,963) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="13" ry="11" fill="#508840" />
                    <ellipse cx="14" cy="27" rx="15" ry="10" fill="#609850" />
                    <ellipse cx="14" cy="31" rx="12" ry="8" fill="#6EA860" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(913,1021) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="12" ry="10" fill="#4A8038" />
                    <ellipse cx="14" cy="27" rx="14" ry="9" fill="#5A9048" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                <g transform="translate(1030,1065) scale(1.667,1.463)">
                    <ellipse cx="14" cy="22" rx="11" ry="9" fill="#508840" />
                    <ellipse cx="14" cy="27" rx="13" ry="8" fill="#609850" />
                    <rect x="11" y="37" width="6" height="10" rx="2" fill="#7A5A28" opacity="0.8" />
                </g>
                ...
                <g transform="translate(230,209)">
                    <circle cx="7" cy="7" r="4" fill="#F4D48E" />
                    <ellipse cx="7" cy="2" rx="3" ry="4" fill="#F4D48E" opacity="0.7" />
                    <ellipse cx="7" cy="12" rx="3" ry="4" fill="#F4D48E" opacity="0.7" />
                    <ellipse cx="2" cy="7" rx="4" ry="3" fill="#F4D48E" opacity="0.7" />
                    <ellipse cx="12" cy="7" rx="4" ry="3" fill="#F4D48E" opacity="0.7" />
                </g>
                ...
                <g transform="translate(280,655)">
                    <circle cx="7" cy="7" r="4" fill="#EFB0A4" />
                    <ellipse cx="7" cy="2" rx="3" ry="4" fill="#EFB0A4" opacity="0.7" />
                    <ellipse cx="7" cy="12" rx="3" ry="4" fill="#EFB0A4" opacity="0.7" />
                    <ellipse cx="2" cy="7" rx="4" ry="3" fill="#EFB0A4" opacity="0.7" />
                    <ellipse cx="12" cy="7" rx="4" ry="3" fill="#EFB0A4" opacity="0.7" />
                </g>
                <g transform="translate(130,787)">
                    <circle cx="7" cy="7" r="4" fill="#EFB0A4" />
                    <ellipse cx="7" cy="2" rx="3" ry="4" fill="#EFB0A4" opacity="0.7" />
                    <ellipse cx="7" cy="12" rx="3" ry="4" fill="#EFB0A4" opacity="0.7" />
                    <ellipse cx="2" cy="7" rx="4" ry="3" fill="#EFB0A4" opacity="0.7" />
                ...
                <g transform="translate(930,553)">
                    <circle cx="7" cy="7" r="4" fill="#C18ACF" />
                    <ellipse cx="7" cy="2" rx="3" ry="4" fill="#C18ACF" opacity="0.7" />
                    <ellipse cx="7" cy="12" rx="3" ry="4" fill="#C18ACF" opacity="0.7" />
                    <ellipse cx="2" cy="7" rx="4" ry="3" fill="#C18ACF" opacity="0.7" />
                    <ellipse cx="12" cy="7" rx="4" ry="3" fill="#C18ACF" opacity="0.7" />
                </g>
                <g transform="translate(1113,963)">
                    <circle cx="7" cy="7" r="4" fill="#C18ACF" />
                    <ellipse cx="7" cy="2" rx="3" ry="4" fill="#C18ACF" opacity="0.7" />
                    <ellipse cx="7" cy="12" rx="3" ry="4" fill="#C18ACF" opacity="0.7" />
                    <ellipse cx="2" cy="7" rx="4" ry="3" fill="#C18ACF" opacity="0.7" />
                ...
                <g transform="translate(1330,597)">
                    <circle cx="7" cy="7" r="4" fill="#F4D48E" />
                    <ellipse cx="7" cy="2" rx="3" ry="4" fill="#F4D48E" opacity="0.7" />
                    <ellipse cx="7" cy="12" rx="3" ry="4" fill="#F4D48E" opacity="0.7" />
                    <ellipse cx="2" cy="7" rx="4" ry="3" fill="#F4D48E" opacity="0.7" />
            ...
            <div class="objects-layer" id="objectsLayer">
                        ...
                        @for($gx = 0; $gx < 8; $gx++)
                            @php
                                $isOccupied = $buildings->whereNotNull('grid_x')
                                    ...
                                    ->count() > 0;
                            @endphp
                            <div class="grid-cell {{ $isOccupied ? 'occupied' : 'available' }}" data-gx="{{ $gx }}"
                                data-gy="{{ $gy }}" @if(!$isOccupied) onclick="selectCell(this)" @endif>
                            </div>
                        @endfor
                    @endfor
                </div>
                ...
                @foreach($buildings->whereNotNull('grid_x') as $b)
                        ...
                        @endphp
                        <div class="building" style="left:{{ $px }}px;top:{{ $py }}px;" onclick="openPanel(
                       '{{ addslashes($b->name) }}',
                       '{{ $b->type }}',
                       {{ $b->level }},
                       {{ $b->completed_count }},
